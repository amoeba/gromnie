...
pub struct LaunchWizard {
    ...
    pub server_list: Vec<(String, crate::config::ServerConfig)>,
    pub account_list: Vec<(String, crate::config::AccountConfig)>,
}
...
impl LaunchWizard {
    ...
    pub fn get_selected_server(&self) -> &crate::config::ServerConfig {
        &self.server_list[self.selected_server_idx].1
    }

    pub fn get_selected_account(&self) -> &crate::config::AccountConfig {
