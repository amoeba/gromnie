...
async fn main() -> Result<(),()> {
    ...
    // TODO: I think this needs to be written at as LE. How do I know this isn't
    // already or how would I know whether this is big endian or not?
	let data = vec![0u8,
    ...
    match socket.recv(&mut buffer) {
        Ok(received) => println!("received {received} bytes {:?}", &buffer[..received]),
